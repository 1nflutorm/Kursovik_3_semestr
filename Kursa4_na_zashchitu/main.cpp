    ...
    while (true)
    {
        ...
        case 11://готово
        {
            ...
            if (!Table.PrintAllPassengersByAirFlight(List, AirFligthNum))//выводим все билеты купленные на этот рейс
                cout << "На этот рейс еще не покупались билеты!\n" << endl;//если таких нет, выводим соответствующее сообщение
            break;
        }
        case 12://готово
        {
            ...
            cout << "Введите фрвгмент названия аэропорта прибытия: ";
            cin >> ArriveAirport;
            cout << "Данные о найденых авиарейсах: " << endl;
            int count = 0;
            ...
            if (!count)//если таких нет, то выводим соответсвуюее сообщение
                cout << "Авиарейсов с таким аэропором прибытия не найдено!" << endl;
            break;
        }
        case 13://готово
        {
